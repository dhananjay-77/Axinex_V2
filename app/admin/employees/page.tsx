          ...
          <table className="w-full min-w-[980px] text-left text-body-md">
            ...
            <tbody>
              {employeesList.map((employee) => (
                <tr key={employee._id || employee.name} className="border-b border-outline-variant/20 transition-colors hover:bg-surface-container-low">
                  ...
                  <td className="px-6 py-5">
                    <span className={`inline-flex rounded-full px-3 py-1 text-caption font-label-md ${getDepartmentTone(employee.department)}`}>
                      {employee.department}
                    </span>
                  </td>
                  <td className="px-6 py-5">
                    <span className={`inline-flex items-center gap-2 text-caption font-label-md ${getStatusTone(employee.status)}`}>
